...
hands = mp_hands.Hands(static_image_mode=False, max_num_hands=1, min_detection_confidence=0.7)  # Adjusted confidence
...
def draw_landmarks_and_prediction(img, hand_landmarks, prediction, confidence):
    ...
    # Draw prediction
    cv2.putText(img, f'Prediction: {prediction} ({confidence:.2f})', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 200), 2)
